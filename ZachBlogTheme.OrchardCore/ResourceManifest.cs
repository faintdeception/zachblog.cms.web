...
namespace OrchardCore.Themes.ZachBlogTheme.OrchardCore
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                .DefineScript("ZachBlogTheme.OrchardCore-vendor-jQuery")
                .SetUrl("~/ZachBlogTheme.OrchardCore/vendor/jquery/jquery.min.js", "~/ZachBlogTheme.OrchardCore/vendor/jquery/jquery.js")
            ...
            manifest
                .DefineScript("ZachBlogTheme.OrchardCore-vendor-jQuery.slim")
                .SetUrl("~/ZachBlogTheme.OrchardCore/vendor/jquery/jquery.slim.min.js", "~/ZachBlogTheme.OrchardCore/vendor/jquery/jquery.slim.js")
            ...
            manifest
                .DefineScript("ZachBlogTheme.OrchardCore-vendor-bootstrap")
                .SetDependencies("ZachBlogTheme.OrchardCore-vendor-jQuery")
                .SetUrl("~/ZachBlogTheme.OrchardCore/vendor/bootstrap/js/bootstrap.min.js", "~/ZachBlogTheme.OrchardCore/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                .DefineScript("ZachBlogTheme.OrchardCore-vendor-bootstrap-bundle")
                .SetDependencies("ZachBlogTheme.OrchardCore-vendor-jQuery")
                .SetUrl("~/ZachBlogTheme.OrchardCore/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/ZachBlogTheme.OrchardCore/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                .DefineStyle("ZachBlogTheme.OrchardCore-vendor-bootstrap")
                .SetUrl("~/ZachBlogTheme.OrchardCore/vendor/bootstrap/css/bootstrap.min.css", "~/ZachBlogTheme.OrchardCore/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                .DefineStyle("ZachBlogTheme.OrchardCore-bootstrap-oc")
                .SetUrl("~/ZachBlogTheme.OrchardCore/css/bootstrap-oc.min.css", "~/ZachBlogTheme.OrchardCore/css/bootstrap-oc.css")
                .SetVersion("1.0.0");
				
            manifest
                .DefineStyle("ZachBlogTheme.OrchardCore-vendor-font-awesome")
                .SetUrl("~/ZachBlogTheme.OrchardCore/vendor/fontawesome-free/css/all.min.css", "~/ZachBlogTheme.OrchardCore/vendor/fontawesome-free/css/all.css")
            ...
            manifest
                .DefineScript("ZachBlogTheme.OrchardCore-vendor-font-awesome")
